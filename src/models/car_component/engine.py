...
class Engine:
    ...
    def measure_engine_horsepower(self):
        self.engine_horsepower=self.engine_mode_base_maximum_horsepower-0.15/10*(100-self.engine_reliability_percent)*self.engine_mode_base_maximum_horsepower-0.03*math.log(self.engine_temperature_celcius)
