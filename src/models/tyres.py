...
class Tyres:
    ...
    def measure_tyre_temperature(self, track_temperature_celcius:int|float, brake_temperature_celcius:int|float):
        ...
        temp_pure_tyre_temperature_celcius=(self.tyre_set_optimal_temperature_celcius+track_temperature_celcius+0.2*brake_temperature_celcius)/3
    ...
    def calculate_tyre_relative_speed_loss(self):
        ...
        self.tyre_relative_speed_loss_km_hr=self.tyre_set_relative_speed_loss_km_hr*(1.5*abs(self.tyre_temperature_celcius-self.tyre_set_optimal_temperature_celcius))+0.15*(100-self.tyre_reliability_percent)