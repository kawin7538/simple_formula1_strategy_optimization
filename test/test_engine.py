...
class TestEngine:
    ...
    def test_init_engine_mode(self):
        ...
        self.engine.init_engine_mode(list_engine_mode_name,list_engine_mode_base_reliability_percent_loss_per_lap,list_engine_mode_base_maximum_horsepower,list_engine_mode_fuel_volume_consuming_kg_per_lap,list_engine_mode_temperature_celcius)
